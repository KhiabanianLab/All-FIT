...
step = 25
#step = 10
subclonalP = [[] for x in range(100/step)]	#[0-25),[25-50),[50-75),[75-]
subclonalIndex = [[] for x in range(100/step)]
...
#		ax = plt.axes()
		...
		if k == 0:	
			...
			cax = ax.scatter(x, y, c=z, s=10, edgecolor='',cmap=cm, vmin=0, vmax=0.018)
		else:
...
#plt.xlabel("Percentage of sub-clonal mutations")
#plt.ylabel("Pearson's correlation between estimated and true purity")
