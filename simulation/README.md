...
- check_accuracy_ignoreNearby.py, subclonal_check_accuracy_interval_ignoreNearby.py, and high_ploidy_check_accuracy_interval_ignoreNearby.py are used to generate accuracy of All-FIT with Pearson's correlation coefficient as well as Figures 4,6,S1-S2. (run these scripts at the directory of /output_PuritySim_Set/)
